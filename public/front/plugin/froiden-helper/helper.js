(function($) {
    ...
    $.easyAjax = function(options) {
        ...
        if (typeof opt.beforeSend != "function") {
            opt.beforeSend = function() {
                ...
                $(opt.container).find(".has-danger").each(function () {
        ...
        function handleFail(response) {
            ...
            if (typeof response.errors != "undefined") {
                ...
                $(opt.container).find(".has-danger").find(".help-block").remove();
                $(opt.container).find(".has-danger").removeClass("has-danger");
                ...
                if (opt.errorPosition == "field") {
                    for (var i = 0; i < keys.length; i++) {
                        ...
                        console.log(['keys',ele, key, opt.container]);
    ...
    $.showErrors = function(object) {
        ...
        $(".has-danger").find(".help-block").remove();
