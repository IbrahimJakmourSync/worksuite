    ...
    <div class="row">
        <div class="col-md-3">
            <div class="white-box bg-inverse">
                <h3 class="box-title text-white">Total Packages</h3>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="<?php echo e(route('super-admin.packages.create')); ?>" class="btn btn-outline btn-success btn-sm">Add New Package <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
        ...
        $(function() {
            var table = $('#users-table').dataTable({
                ...
                columns: [
                    ...
                    { data: 'max_file_size', name: 'max_file_size' },
