            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="<?php echo e(route('admin.expenses.create')); ?>" class="btn btn-outline btn-success btn-sm"><?php echo app('translator')->getFromJson('modules.expenses.addExpense'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
                ...
                <div class="row b-b b-t" style="display: none; background: #fbfbfb;" id="ticket-filters">
                    ...
                    <form action="" id="filter-form">
                        ...
                        <div class="col-md-3">
                            <h5 ><?php echo app('translator')->getFromJson('app.employee'); ?></h5>
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <select class="form-control selectpicker" name="status" id="status" data-style="form-control">
                                    ...
                                    <option value="rejected"><?php echo app('translator')->getFromJson('app.reject'); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="invoice-table">
                        ...
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson('modules.expenses.itemName'); ?></th>
                            <th><?php echo app('translator')->getFromJson('app.price'); ?></th>
                            <th><?php echo app('translator')->getFromJson('modules.expenses.purchaseFrom'); ?></th>
                            <th><?php echo app('translator')->getFromJson('app.menu.employees'); ?></th>
                            <th><?php echo app('translator')->getFromJson('modules.expenses.purchaseDate'); ?></th>
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('admin.expenses.data'); ?>?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status + '&employee=' + employee,
            "order": [[ 0, "desc" ]],
            language: {
    ...
    function exportData(){
        ...
        var url = '<?php echo e(route('admin.expenses.export', [':startDate', ':endDate', ':status', ':employee'])); ?>';
