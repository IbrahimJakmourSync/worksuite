<ul class="nav tabs-vertical">
    ...
    <li class="tab <?php if($type == 'admin'): ?> active <?php endif; ?>">
        <a href="<?php echo e(route('admin.module-settings.index')); ?>"><?php echo app('translator')->getFromJson('app.menu.adminModule'); ?></a></li>
    <li class="tab <?php if($type == 'employee'): ?> active <?php endif; ?>">
        <a href="<?php echo e(route('admin.module-settings.index')); ?>?type=employee"><?php echo app('translator')->getFromJson('app.menu.employeeModule'); ?></a></li>
    <li class="tab <?php if($type == 'client'): ?> active <?php endif; ?>">
        <a href="<?php echo e(route('admin.module-settings.index')); ?>?type=client"><?php echo app('translator')->getFromJson('app.menu.clientModule'); ?></a></li>
</ul>
