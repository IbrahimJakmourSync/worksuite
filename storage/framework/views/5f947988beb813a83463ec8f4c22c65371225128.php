                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?php if($user->can('add_estimates')): ?>
                                <a href="<?php echo e(route('member.estimates.create')); ?>" class="btn btn-outline btn-success btn-sm"><?php echo app('translator')->getFromJson('modules.estimates.createEstimate'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
                            <?php endif; ?>
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "<?php echo e(route('member.estimates.destroy',':id')); ?>";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '<?php echo route('member.estimates.data'); ?>?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status,
            "order": [[ 0, "desc" ]],
            language: {
