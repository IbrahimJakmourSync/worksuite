...
<head>
    ...
    <title> Super Admin Panel | <?php echo e($pageTitle); ?></title>
    <!-- Bootstrap Core CSS -->
...
<div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <div class="top-left-part">
                ...
                <a class="logo hidden-xs hidden-sm text-center" href="<?php echo e(route('super-admin.dashboard')); ?>">
                    ...
                    <img src="<?php echo e(asset('logo-1.png')); ?>" alt="home" class=" admin-logo"/>
                    <?php else: ?>
    ...
    <div id="page-wrapper">
        ...
        <!-- /.container-fluid -->
        <footer class="footer text-center"> <?php echo e(\Carbon\Carbon::now()->year); ?> &copy; Worksuite </footer>
    </div>
    <!-- /#page-wrapper -->
</div>
<!-- /#wrapper -->
