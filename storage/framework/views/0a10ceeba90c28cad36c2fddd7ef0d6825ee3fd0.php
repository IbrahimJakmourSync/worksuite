                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('member.expenses.create')); ?>" class="btn btn-outline btn-success btn-sm"><?php echo app('translator')->getFromJson('modules.expenses.addExpense'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="invoice-table">
                        ...
                        <tr>
                            ...
                            <?php if($user->can('view_expenses')): ?>
                                <th><?php echo app('translator')->getFromJson('modules.employees.title'); ?></th>
                            <?php endif; ?>
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "<?php echo e(route('member.expenses.destroy',':id')); ?>";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '<?php echo route('member.expenses.data'); ?>?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status + '&employee=' + employee,
            "order": [[ 0, "desc" ]],
            language: {
