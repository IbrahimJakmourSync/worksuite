    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(route('admin.leaves.index')); ?>"><?php echo e($pageTitle); ?></a></li>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <label class="control-label"><?php echo app('translator')->getFromJson('modules.leaves.leaveType'); ?> <a href="javascript:;"
                                                                                                                  id="addLeaveType" class="btn btn-sm btn-outline btn-success"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('modules.leaves.addLeaveType'); ?></a>
                                        </label>
...
<script>
    ...
    $('#save-form-2').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('admin.leaves.store')); ?>',
