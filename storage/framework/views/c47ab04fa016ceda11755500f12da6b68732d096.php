...
<head>
    ...
    <title><?php if($userRole): ?> <?php echo e($userRole->display_name); ?> <?php echo app('translator')->getFromJson("app.panel"); ?>  <?php else: ?> <?php echo app('translator')->getFromJson("app.employeePanel"); ?> <?php endif; ?> | <?php echo e(__($pageTitle)); ?></title>
    <!-- Bootstrap Core CSS -->
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            ...
            <div class="top-left-part">
                <!-- Logo -->
                <a class="logo hidden-xs hidden-sm text-center" href="<?php echo e(route('member.dashboard')); ?>">
                    <!-- Logo icon image, you can use font-icon also -->
                        <?php if(is_null($global->logo)): ?>
                        <!--This is dark logo icon-->
                            <img src="<?php echo e(asset('worksuite-logo.png')); ?>" alt="home" class=" member-logo" />
                        <?php else: ?>
                            <img src="<?php echo e(asset('user-uploads/app-logo/'.$global->logo)); ?>" alt="home"  />
                        <?php endif; ?>
                </a>

                <div class="member-panel-name hidden-xs"><?php if($userRole): ?> <?php echo e($userRole->display_name); ?> <?php echo app('translator')->getFromJson("app.panel"); ?>  <?php else: ?> <?php echo app('translator')->getFromJson("app.employeePanel"); ?> <?php endif; ?></div>
                    ...
                    <?php if(!is_null($timer)): ?>
                        <div class="nav navbar-top-links navbar-right pull-right m-t-10">
                            <a class="btn btn-rounded btn-default stop-timer-modal" href="javascript:;" data-timer-id="<?php echo e($timer->id); ?>">
                                ...
                                <label class="label label-danger"><?php echo app('translator')->getFromJson("app.stop"); ?></label></a>
                        </div>
                    <?php else: ?>
                        <div class="nav navbar-top-links navbar-right pull-right m-t-10">
                            <a class="btn btn-rounded btn-default timer-modal" href="javascript:;"><?php echo app('translator')->getFromJson("modules.timeLogs.startTimer"); ?> <i class="fa fa-check-circle text-success"></i></a>
                        </div>
                    <?php endif; ?>
                </span>
            <?php endif; ?>
            ...
            <?php if(in_array('timelogs',$user->modules) && isset($activeTimerCount)): ?>
                ...
                <div class="nav navbar-top-links navbar-right m-t-10 m-r-10">
                    <a class="btn btn-rounded btn-default active-timer-modal" href="javascript:;"><?php echo app('translator')->getFromJson("modules.projects.activeTimers"); ?>
