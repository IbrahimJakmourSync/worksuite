    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">Your Current Plan (<?php echo e($company->package->name); ?>)
                    ...
                    <?php endif; ?>
                    <div class="pull-right" style="margin-top: -7px;"><a href="<?php echo e(route('admin.billing.packages')); ?>" class="btn btn-block btn-success waves-effect text-center">Change Plan</a> </div></div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="row f-15 m-b-10">
                            ...
                            <div class="col-sm-3">
                                $<?php echo e($company->package->annual_price); ?>
                        ...
                        <div class="row f-15 m-b-10">
                            ...
                            <div class="col-sm-3">
                                $<?php echo e($company->package->monthly_price); ?>
                ...
                <div class="table-responsive">
                    <table class="table color-table info-table" id="users-table">
                        ...
                        <tr>
                            ...
                            <th>Next <?php echo app('translator')->getFromJson('app.date'); ?></th>
