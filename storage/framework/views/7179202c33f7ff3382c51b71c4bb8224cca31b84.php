...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row m-b-10">
        ...
        <div class="col-md-3">
            <h5 class="box-title m-t-30"><?php if($logTimeFor->log_time_for == 'task'): ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                            <?php if($logTimeFor->log_time_for == 'task'): ?>
                                <select class="select2 form-control"  data-placeholder="<?php echo app('translator')->getFromJson('app.selectTask'); ?>" id="task_id">
                                    <option value=""></option>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <button type="button" id="filter-results" class="btn btn-success col-md-6"><i class="fa fa-check"></i> <?php echo app('translator')->getFromJson('app.apply'); ?></button>
...
<script>
    ...
    function showTable(){
        ...
        var url = '<?php echo e(route('member.all-time-logs.data', [':startDate', ':endDate', ':projectId', ':employee'])); ?>';
