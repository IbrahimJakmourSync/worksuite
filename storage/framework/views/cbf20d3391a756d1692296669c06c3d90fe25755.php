                ...
                <div class="col-12 col-md-4">
                    <div class="pricing-1">
                        ...
                        <h2 class="price <?php echo e($color); ?>">
                            <?php if($package->monthly_price != 0): ?> <span class="price-unit"><?php echo e($global->currency->currency_symbol); ?></span> <?php endif; ?>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-12 col-md-4">
                    <div class="pricing-1">
                        ...
                        <br>
                        <h2 class="price <?php echo e($color); ?>">
                            <?php if($package->annual_price != 0): ?> <span class="price-unit"><?php echo e($global->currency->currency_symbol); ?></span> <?php endif; ?>
