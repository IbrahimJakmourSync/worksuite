...
<head>
    ...
    <title>Client Panel | <?php echo e(__($pageTitle)); ?></title>
    <!-- Bootstrap Core CSS -->
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            ...
            <div class="top-left-part">
                ...
                <a class="logo hidden-xs hidden-sm text-center" href="<?php echo e(route('client.dashboard.index')); ?>">
                    <!-- Logo icon image, you can use font-icon also -->
                        ...
                        <!--This is dark logo icon-->
                            <img src="<?php echo e(asset('worksuite-logo.png')); ?>" alt="home" class=" client-logo" />
                        <?php else: ?>
                ...
                <div class="client-panel-name hidden-xs"><?php echo app('translator')->getFromJson('app.clientPanel'); ?></div>
            </div>
            <!-- /Logo -->
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <li class="dropdown">
                    <select class="selectpicker language-switcher" data-width="fit">
                        <option value="en" <?php if($user->locale == "en"): ?> selected <?php endif; ?> data-content='<span class="flag-icon flag-icon-us"></span> En'>En</option>
                        <?php $__currentLoopData = $languageSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($language->language_code); ?>" <?php if($user->locale == $language->language_code): ?> selected <?php endif; ?>  data-content='<span class="flag-icon flag-icon-<?php echo e($language->language_code); ?>"></span> <?php echo e($language->language_code); ?>'><?php echo e($language->language_code); ?></option>
