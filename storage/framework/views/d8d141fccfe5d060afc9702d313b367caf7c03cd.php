                                ...
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-xs-12">
                                            <div class="form-group">
                                                <label for="google_map_key"><?php echo app('translator')->getFromJson('modules.accountSettings.google_map_key'); ?></label>
                                                <input type="tel" class="form-control" id="google_map_key" name="google_map_key"
                                                       value="<?php echo e($global->google_map_key); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-xs-12">
                                            <div class="form-group">
                                                <label for="google_map_key"><?php echo app('translator')->getFromJson('modules.accountSettings.google_recaptcha_key'); ?></label>
