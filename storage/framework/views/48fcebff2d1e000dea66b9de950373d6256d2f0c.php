                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?php if($user->can('add_lead')): ?>
                                <a href="<?php echo e(route('member.leads.create')); ?>" class="btn btn-outline btn-success btn-sm"><?php echo app('translator')->getFromJson('modules.lead.addNewLead'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
                            <?php endif; ?>
