                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?php if($user->can('add_invoices')): ?>
                                <a href="<?php echo e(route('member.all-invoices.create')); ?>" class="btn btn-outline btn-success btn-sm"><?php echo app('translator')->getFromJson('modules.invoices.addInvoice'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
                            <?php endif; ?>
                ...
                <div class="modal-body">
                    <div class="row" id="file-dropzone">
                        <div class="row m-b-20" id="file-dropzone">
                            <div class="col-md-12">
                                <form action="<?php echo e(route('member.invoiceFile.store')); ?>"
                                      class="dropzone"
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "<?php echo e(route('member.all-invoices.destroy',':id')); ?>";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '<?php echo route('member.all-invoices.data'); ?>?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status + '&projectID=' + projectID,
            "order": [[ 0, "desc" ]],
            language: {
